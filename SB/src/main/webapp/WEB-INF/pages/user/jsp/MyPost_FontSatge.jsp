                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <span
                                                                                                                        class="userimage"><img
                                                                                                                            ...
                                                                                                                            alt=""></span>
                                                                                                                    <span
                                                                                                                        class="username">${userBean.userChineseName}</span>
                                                                                                                    <!-- <span
                                                                                                                class="pull-right text-muted">82
                                                                                                                Views</span> -->
                                                                                                                </div>
                                                                                                                <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <span
                                                                                                                        ...
                                                                                                                        ${fn:length(post.likesBean)}</span>
                                                                                                                    <span
                                                                                                                        class="m-r-15 text-inverse-lighter"><i
                                                                                                                            class="fa fa-comments fa-fw fa-lg m-r-3"></i>
                                                                                                                        ${fn:length(post.repliesBean)}</span>
                                                                                                                    <span
