    ...
    <div class="container">
        ...
        <div class="row g-3">
            ...
            <ul class="nav nav-tabs" id="tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="profileTab" data-bs-toggle="tab"
                        data-bs-target="#profileTabPane" type="button" role="tab" aria-controls="profileTabPane"
                        aria-selected="true">
                        基本資料
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="photosTab" data-bs-toggle="tab" data-bs-target="#photosTabPane"
                        type="button" role="tab" aria-controls="photosTabPane" aria-selected="false">
                        主題照片
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="accordionTab" data-bs-toggle="tab" data-bs-target="#tagsTabPane"
                        type="button" role="tab" aria-controls="accordionTabPane" aria-selected="false">
                        自訂標籤
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="accordionTab" data-bs-toggle="tab" data-bs-target="#othersTabPane"
                        type="button" role="tab" aria-controls="accordionTabPane" aria-selected="false">
                        其他
                    </button>
                </li>
            ...
            <div class="tab-content" id="tabContent">
                ...
                <!-- 基本資料 -->
                <div class="tab-pane fade show active" id="profileTabPane" role="tabpanel" aria-labelledby="profileTab"
                    tabindex="0">
                    <div class="mb-3">
                        <div>
                            <form class="file-upload">
                                <div class="row mb-5 gx-5">
                                    ...
                                    <div class="col-xxl-8 mb-5 mb-xxl-0">
                                        <div class="bg-secondary-soft px-4 py-5 rounded">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="inputGender" class="form-label"> 性別 *</label>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="date" name="birthday"
                                                        ...
                                                        onchange="calculateZodiac()">
                                                </div>

                                                <div class="col-md-6">
                                                    <label class="form-label">星座 *</label>
                                                    <input type="text" class="form-control" id="zodiac" name="starSign"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select id="inputBloodType" class="form-select" name="bloodType">
                                                        <option value="" ${empty userBean.bloodType ? "selected" : ""}>選擇血型</option>
														<option value="A" ${userBean.bloodType == "A" ? "selected" : ""}>A</option>
    													<option value="B" ${userBean.bloodType == "B" ? "selected" : ""}>B</option>
    													<option value="O" ${userBean.bloodType == "O" ? "selected" : ""}>O</option>
    													<option value="AB" ${userBean.bloodType == "AB" ? "selected" : ""}>AB</option>
    													<option value="其他" ${userBean.bloodType == "其他" ? "selected" : ""}>其他</option>   														
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        <select id="inputMBTI" class="form-select" name="MBTI">
    														<option value="" ${empty userBean.MBTI ? "selected" : ""}>選擇 MBTI 類型</option>
    														<option value="ISTJ" ${userBean.MBTI == "ISTJ" ? "selected" : ""}>ISTJ</option>
  													    	<option value="ISTP" ${userBean.MBTI == "ISTP" ? "selected" : ""}>ISTP</option>
    														<option value="ISFJ" ${userBean.MBTI == "ISFJ" ? "selected" : ""}>ISFJ</option>
    														<option value="ISFP" ${userBean.MBTI == "ISFP" ? "selected" : ""}>ISFP</option>
                                                            <option value="INTJ" ${userBean.MBTI == "INTJ" ? "selected" : ""}>INTJ</option>
                                                            <option value="INTP" ${userBean.MBTI == "INTP" ? "selected" : ""}>INTP</option>
                                                            <option value="INFJ" ${userBean.MBTI == "INFJ" ? "selected" : ""}>INFJ</option>
                                                            <option value="INFP" ${userBean.MBTI == "INFP" ? "selected" : ""}>INFP</option>
                                                            <option value="ESTJ" ${userBean.MBTI == "ESTJ" ? "selected" : ""}>ESTJ</option>
                                                            <option value="ESTP" ${userBean.MBTI == "ESTP" ? "selected" : ""}>ESTP</option>
                                                            <option value="ESFJ" ${userBean.MBTI == "ESFJ" ? "selected" : ""}>ESFJ</option>
                                                            <option value="ESFP" ${userBean.MBTI == "ESFP" ? "selected" : ""}>ESFP</option>
                                                            <option value="ENTJ" ${userBean.MBTI == "ENTJ" ? "selected" : ""}>ENTJ</option>
                                                            <option value="ENTP" ${userBean.MBTI == "ENTP" ? "selected" : ""}>ENTP</option>
                                                            <option value="ENFJ" ${userBean.MBTI == "ENFJ" ? "selected" : ""}>ENFJ</option>
                                                            <option value="ENFP" ${userBean.MBTI == "ENFP" ? "selected" : ""}>ENFP</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select id="inputGoalNo" class="form-select" name="goalNo">
                                                 	    <option value="" ${empty userBean.goalNo ? "selected" : ""}>選擇想要尋找的關係</option> 
                                                        <option value="1" ${userBean.goalNo == 1 ? "selected" : ""}>不回答</option>
                                                        <option value="2" ${userBean.goalNo == 2 ? "selected" : ""}>網友</option>
                                                        <option value="3" ${userBean.goalNo == 3 ? "selected" : ""}>飯友</option>
                                                        <option value="4" ${userBean.goalNo == 4 ? "selected" : ""}>酒友</option>
                                                        <option value="5" ${userBean.goalNo == 5 ? "selected" : ""}>牌友</option>
                                                        <option value="6" ${userBean.goalNo == 6 ? "selected" : ""}>山友</option>
                                                        <option value="7" ${userBean.goalNo == 7 ? "selected" : ""}>旅伴</option>
                                                        <option value="8" ${userBean.goalNo == 8 ? "selected" : ""}>戀愛伴侶</option>
                                                        <option value="9" ${userBean.goalNo == 9 ? "selected" : ""}>結婚對象</option>
                                                        <option value="10" ${userBean.goalNo == 10 ? "selected" : ""}>朋友關係</option>
                                                        <option value="11" ${userBean.goalNo == 11 ? "selected" : ""}>短暫浪漫</option>
                                                        <option value="12" ${userBean.goalNo == 12 ? "selected" : ""}>匿名網友</option>
                                                        <option value="13" ${userBean.goalNo == 13 ? "selected" : ""}>一起運動</option>
                                                        <option value="14" ${userBean.goalNo == 14 ? "selected" : ""}>一起團購</option>
                                                        <option value="15" ${userBean.goalNo == 15 ? "selected" : ""}>外送拼單</option>
                                                        <option value="16" ${userBean.goalNo == 16 ? "selected" : ""}>不設限</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="bg-secondary-soft px-4 py-5 rounded">
                                            <div class="row g-3">
                                                <h4 class="mb-4 mt-0 text-center">上傳頭像</h4> <!-- 將這行文字置中 -->
                                                <div class="text-center"> <!-- 要加上 text-center 類，要不然下面的樣式會跑掉 -->

                                                    <!--顯示用戶的頭像或者預設的用戶圖示 - Font Awesome圖標-->
                                                    <div class="square position-relative display-2 mb-3">
                                                        <img src="https://p1-tt.byteimg.com/origin/tos-cn-i-qvj2lq49k0/a2752baadcc147cb80408dc7179fe65b.jpg"
                                                            alt="Avatar"
                        ...
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <input type="file" id="customFile1" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <input type="file" id="customFile2" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        旅行壯遊
                                    </div>
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <input type="file" id="customFile3" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        我的寵物
                                    </div>
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <input type="file" id="customFile4" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        偉大紀錄
                                    </div>
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <input type="file" id="customFile5" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        展露身材
                                    </div>
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <input type="file" id="customFile6" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        性感的我
                                    </div>
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <input type="file" id="customFile7" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        玩樂的我
                                    </div>
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <input type="file" id="customFile8" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        時尚的我
                                    </div>
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <input type="file" id="customFile9" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        我的作品
                                    </div>
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <input type="file" id="customFile10" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        我的收藏
                                    </div>
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <label for="customFile11" class="square position-absolute top-50 start-50 translate-middle display-2">
                                        <i class="fas fa-fw fa-plus text-secondary add-photo"></i>
                                    </label>
                                    <input type="file" id="customFile11" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        最愛的美食
                                    </div>
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <input type="file" id="customFile12" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        最愛的電影
                                    </div>
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <label for="customFile13" class="square position-absolute top-50 start-50 translate-middle display-2">
                                        <i class="fas fa-fw fa-plus text-secondary add-photo"></i>
                                    </label>
                                    <input type="file" id="customFile13" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        最愛的書本
                                    </div>
                            ...
                            <div class="item">
                                <div class="photo-container position-relative">
                                    ...
                                    <input type="file" id="customFile14" name="file" hidden>
                                    <!-- 新增的空白區塊用來放置主題文字 -->
                                    <div class="theme-name text-center p-2">
                                        最愛的遊戲
                                    </div>
                ...
                <div class="tab-pane fade" id="tagsTabPane" role="tabpanel" aria-labelledby="tagsTab" tabindex="0">
                    ...
                    <div class="row mb-5 gx-5">
                        <div class="col-xxl-6 mb-5 mb-xxl-0">
                            <div class="bg-secondary-soft px-4 py-5 rounded">
                                <div class="row g-3">
                                    ...
                                    <!--Tagify標籤輸入外掛-->
                                    <input name='tags-manual-suggestions' placeholder='輸入文字查詢標籤 / 限制只能選15個' style="margin-bottom: 10px;"> <!-- 調整下方 margin -->
                                    <div class="d-flex justify-content-between align-items-center mt-4">
                                        <h3 class="mb-0 tag-label">☝ 從以下清單中新增標籤:</h3>
                                        <button class='tags--removeAllBtn'>清除全部</button> <!-- 調整上方 margin -->
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="gap-3 d-md-flex justify-content-md-end text-center my-5 ">
                            <button type="button" class="btn btn-primary btn-lg" onclick="updatePhotos()">確定修改</button>
                            <button type="button" class="btn btn-danger btn-lg"> 確定刪除 </button>
                        </div>
                    </form>
                </div>
        ...
        function updatePhotos() {
            ...
            photoContainers.forEach((container, index) => {
                ...
                if (img) {
                    const photoTheme = container.querySelector('.theme-name').textContent.trim();
                    const photoFile = img.src;

                    formData.append(`photoTheme[${index}]`, photoTheme);
                    formData.append(`photoFile[${index}]`, photoFile);
                }
            });
