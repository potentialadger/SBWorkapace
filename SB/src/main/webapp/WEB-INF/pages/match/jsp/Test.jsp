...
<head>
	...
	<link rel="stylesheet" href="mycss/SuccessPeople.css">
			...
			<c:forEach var="matchData" items="${matchedUsersData}">
						  <div class="col-lg-6 mt-4 mt-lg-0">
							<div class="member d-flex align-items-start">
							  <div class="pic"><img src="https://th.bing.com/th/id/OIP.1E2uPdWprrqMH39OUUPqdwHaHa?rs=1&pid=ImgDetMain" class="img-fluid" alt=""></div>
