...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">   <!--FontAwesome圖標字體-->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/hammer.js/2.0.8/hammer.min.js"></script>    <!--Hammer.js庫來處理手勢事件-->
    ...
    <style>
      * { margin: 0px; padding: 0px; }  /*leftside*/
...
#leftmenu span{
    ...
    position: relative; /* 為了使用 left 屬性，需要设置 position 為 relative 或 absolute */
    left: 18px; /* 負值表示向左移動 */
    top:3px;
}
...
/*調整左邊欄位裡面按鈕的位置*/     
#leftmenu span.friends{margin-bottom:-1px;}
#leftmenu span.chats{background-position:-95px 25px; cursor:pointer;}
#leftmenu span.chats:hover{background-position:-95px -46px; cursor:pointer;}
#leftmenu span.history{background-position:-190px 24px; cursor:pointer;}
#leftmenu span.history:hover{background-position:-190px -47px; cursor:pointer;}  
...
.p1 #profile{
	background:#fff url("https://watermark.lovepik.com/photo/40030/3639.jpg_wh1200.jpg") 0 0 no-repeat;
}
...
<div id="menu">
	...
	<div id="friendslist">
       ...
       <a href="" class="nav-link icon" id="edit">
