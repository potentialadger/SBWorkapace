															...
															<tr>
																...
																<% Date endTime=group.getgEndTime(); SimpleDateFormat
																	...
																	<% String paymentMethodDisplay="" ; switch
																		...
																		: paymentMethodDisplay="面交, SB點數" ; break; case
																		123 : paymentMethodDisplay="匯款, 面交, SB點數" ;
																					...
																					<div class="modal-body"
																						...
																						<div
																							...
																							<label><input
																									...
																									name="payment"
																									value="1"
																									style="margin-right: 5px" />匯款</label>&nbsp;
																							<label><input
																									type="checkbox"
																									name="payment"
																									value="2"
																									style="margin-right: 5px" />面交</label>
																							<label><input
																									type="checkbox"
																									name="payment"
																									value="3"
																									style="margin-right: 5px" />SB點數</label>
																						</div>
																						<div
																							style="display: flex; align-items: center; margin-bottom: 10px">
																							<div style="width: 150px">
																							...
																							<input type="number"
																								name="MinTotalAmount"
																								class="swal2-input"
																								value="<%=group.getgMinTotalAmount()%>" />
																						</div>
																						<div
																							style="display: flex; align-items: center; margin-bottom: 10px">
																							<div style="width: 150px">
															...
															<tr>
																...
																<% Date setTime=order.getSetTime(); SimpleDateFormat
																	...
																	<% String paymentMethodDisplay="" ; switch
																		...
																		<td><button class="btn btn-primary btn-lg"><i
