										...
										<div class="inner-sidebar">
											...
											<div class="inner-sidebar-header justify-content-center">
												<form method="get" action="/postsFrontDesk/InsertPostsCategories">
													<button class="btn btn-primary has-icon btn-block" type="submit"
													...
													<div class="card mb-2">
														<div class="card-body p-2 p-sm-3">
															<div class="media forum-item">
																<img src="http://localhost:8080/localimages/${post.userBean.avatar}"
																	class="mr-3" width="50" alt="User"
																	style="border-radius: 50%;" />
																<div class="media-body">
																	<h5><a href="/postsFrontDesk/SelectPosts?postsNo=${post.post_no}"
																			class="text-body"
																			style="font-weight:bold;">${post.title}</a>
																	</h5>
																	</h5>
																	...
																	${post.categoriesBean.title_name}

																	<c:if test="${not empty post.image_url}">
																		<img src="http://localhost:8080/localimages/${post.image_url}"
																			style="width: 200px; height: auto; position: absolute; top: 10px; left: 450px;">
																	</c:if>

																	<p class="text-muted"><span
																			class="text-secondary font-weight-bold">${post.update_date}</span>
																	</p>
																</div>
																<div
																	...
																	<span><i class="far fa-comment ml-2"></i>
																		${post.repliesBean.size()}</span>
																	<span>${post.likesBean.size()} Likes</span>
																</div>
															</div>
														</div>
													</div>
														...
														<div class="media forum-item">
															...
															<div class="media-body ml-3">
																<a href="javascript:void(0)"
																	class="text-secondary">Mokrani</a>
																...
																<div class="mt-3 font-size-sm">
																	...
																	<p>
																		...
																		from
																		database in
																		realtime for my dashboard anaytics and i found a
																		solution
																		with ajax but
																		it dosen't work if any one have a simple
																		solution it will be
																		helpful
																	</p>
																	<p>Thank</p>
												...
												<div class="card mb-2">
													<div class="card-body">
														<div class="media forum-item">
															...
															<div class="media-body ml-3">
																<a href="javascript:void(0)"
																	class="text-secondary">drewdan</a>
																<small class="text-muted ml-2">1 hour ago</small>
																<div class="mt-3 font-size-sm">
																	<p>What exactly doesn't work with your ajax calls?
																	</p>
																	<p>Also, WebSockets are a great solution for
																		realtime data on a
																		dashboard.
																		Laravel offers this out of the box using
																		broadcasting</p>
																</div>
																...
																<a href="javascript:void(0)"
																	class="text-muted small">Reply</a>
															</div>
														</div>
													</div>
												</div>
